...
#tupe of rcn class names
rcnTuple= (u'NY Portfolio and Restoration Communities (Avg Resilience)', u'NY Continental Connectors', u'Resilient Diffuse Flow High', u'Resilient Diffuse Flow High with Recognized Biodiversity', u'Diffuse Flow (Climate Informed)',
u'Diffuse Flow (Climate Informed) with Recognized Biodiversity', u'Concentrated Flow', u'Concentrated Flow (Climate Informed)', u'Resilient Land with Recognized Biodiversity Value', u'Resilient Land (Secured)',
u'Coastal Marsh Migration Space')
...
#rcnClasses = {class value in grid: rcn class}
rcnClasses = {100: u'NY Portfolio and Restoration Communities (Avg Resilience)', 200: u'NY Continental Connectors', 10: u'Resilient Diffuse Flow High', 11: u'Resilient Diffuse Flow High with Recognized Biodiversity',
12: u'Diffuse Flow (Climate Informed)', 13: u'Diffuse Flow (Climate Informed) with Recognized Biodiversity', 14: u'Concentrated Flow', 15: u'Concentrated Flow (Climate Informed)',
16: u'Resilient Land with Recognized Biodiversity Value', 17: u'Resilient Land (Secured)', 18: u'Coastal Marsh Migration Space'}
...
meanColDictionary = {'landuseintensificationrisk': 3, 'floodplainfunction': 4, 'freshwaterprovision': 5, 'freshwaternpsmitigation': 6, 'freshwaternpsprevention': 7, 'riparianfunction': 8, 'aquaticdiversity': 9, 'streamphysicalvariety': 10,
'floodplainhabitat': 11,'wetlandhabitat': 12, 'streamresilience': 13, 'carbonsequestration': 14, 'carbonstorage': 15, 'terrestrialclimateflow': 16,'terrestrialconnectivity': 17, 'terrestrialhabitatquality': 18, 'terrestrialdiversity': 19,
'terrestrialhabitatvariety': 20, 'terrestrialphysicalvariety': 21, 'terrestrialresilience': 22, 'marinenprevention': 23, 'marinenpsreduction': 24, 'shorelinedynamics': 25, 'futuretidalwetlands': 26, 'presenttidalwetlands': 27,'flooddamageprevention': 28,
'flooddamageprevention_fn': 29, 'flooddamageprevention_bp': 30,'flooddamageprevention_bv': 31, 'marinestormsurgemitigation': 32,'marinestormsurgemitigation_fn': 33, 'marinestormsurgemitigation_bp': 34,'marinestormsurgemitigation_bv': 35,
'riverinefpfloodmitigation': 36,'riverinefpfloodmitigation_fn': 37,'riverinefpfloodmitigation_bp': 38,'riverinefpfloodmitigation_bv': 39,'riverinelandscapefloodreduction': 40,'riverinelandscapefloodreduction_fn': 41,'riverinelandscapefloodreduction_bp': 42,
'riverinelandscapefloodreduction_bv': 43,'freshwateraquaticrecreation': 44, 'freshwateraquaticrecreation_fn': 45,'freshwateraquaticrecreation_bp': 46,'freshwateraquaticrecreation_bv': 47,'marineaquaticrecreation': 48,'marineaquaticrecreation_fn': 49,
'marineaquaticrecreation_bp': 50,'marineaquaticrecreation_bv': 51, 'terrestrialrecreation': 52,'terrestrialrecreation_fn': 53,'terrestrialrecreation_bp': 54, 'terrestrialrecreation_bv': 55, 'heatmitigation': 56,'heatmitigation_fn': 57,'heatmitigation_bp': 58,
'heatmitigation_bv': 59,'groundwatersupply': 60,'groundwatersupply_fn': 61,'groundwatersupply_bp': 62,'groundwatersupply_bv': 63,'surfacewatersupply': 64,'surfacewatersupply_fn': 65,'surfacewatersupply_bp': 66,'surfacewatersupply_bv': 67}
...
#rcnDictionary = {rcn class: column number for results in excel spreadsheet}
rcnDictionary = {'% Project area in RCN': 3,"Total area in RCN": 4, u'Resilient Diffuse Flow High': 5, u'Resilient Diffuse Flow High with Recognized Biodiversity': 6, u'Diffuse Flow (Climate Informed)': 7,
u'Diffuse Flow (Climate Informed) with Recognized Biodiversity': 8, u'Concentrated Flow': 9, u'Concentrated Flow (Climate Informed)': 10, u'Resilient Land with Recognized Biodiversity Value': 11, u'Resilient Land (Secured)': 12,
u'Coastal Marsh Migration Space': 13, u'NY Portfolio and Restoration Communities (Avg Resilience)': 14, u'NY Continental Connectors': 15}
...
u'marinestormsurgemitigation_fn', u'marinestormsurgemitigation', u'heatmitigation', u'riverinefpfloodmitigation', u'riverinefpfloodmitigation_fn', u'riverinefpfloodmitigation_bp', u'riverinefpfloodmitigation_bv',u'flooddamageprevention_bp',
u'flooddamageprevention_bv', u'marineaquaticrecreation_bp', u'marineaquaticrecreation_bv',u'marineaquaticrecreation_fn', u'marinestormsurgemitigation_bp', u'marinestormsurgemitigation_bv']

#list of data that is under development
devList = ['carbonsequestration', 'terrestrialclimateflow','riverinelandscapefloodreduction','riverinelandscapefloodreduction_fn','riverinelandscapefloodreduction_bp','riverinelandscapefloodreduction_bv']
...
u'streamphysicalvariety': 83387.74, u'floodplainfunction': 70631.5, u'freshwateraquaticrecreation': 55585.03, u'marinestormsurgemitigation': 46368.62, u'riverinelandscapefloodreduction': 55867.92, u'freshwaternpsmitigation': 90260.0,
u'futuretidalwetlands': 71602.0, u'carbonstorage': 71535.31, u'surfacewatersupply': 65891.88, u'wetlandhabitat': 90214.87, u'shorelinedynamics': 41931.13, u'terrestrialconnectivity': 83698.2, u'riverinefpfloodmitigation': 51832.42}
...
rcnResults = dict() #rcnResults = {projID: {rncClass: hectares, rcnClass: hectares ...} ...}
...
with arcpy.da.UpdateCursor(projWork,[projIDField,'FIRST_' + str(projNameField),"SAT_Hectares"]) as cursor:
    for row in cursor:
        ...
        if row[2] < 1:
            ...
            #prepare rcnResults dictionary for current project polygon (to populate later)
            rcnResults[row[0]] = dict()
            for rowRcn in rcnTuple:
                rcnResults[row[0]][rowRcn] = 0.00
            rcnResults[row[0]]["Total area in RCN"] = 0.00
            rcnResults[row[0]]["% Project area in RCN"] = 0.00
...
#Calculate rcn class counts by supplied projID
rcnCounts = scratch + "\\" + str(queName) + "_" + str(runStamp) + "_intersectrcn_FINAL"
toDelete.append(rcnCounts)
arcpy.Statistics_analysis(intersect, rcnCounts, [['POINTID', 'COUNT']], [projIDField, 'rcn'])
...
#define field names for search cursor
rcnFields =[projIDField, 'rcn', 'COUNT_POINTID']

#iterate through rows in rcnCounts table retrieving rcn class and number of cells, and writing to rcnResults dictionary
with arcpy.da.SearchCursor(rcnCounts, rcnFields) as cursor:
    for row in cursor:
        projID = row[0]
        currrcn = row[1]

        #if currrcn is None type pass
        if currrcn is None:
            pass

        #else, retrieve the result and write to rcnResults dictionary
        else:
            rcnName = rcnClasses[currrcn]
            rcnResults[projID][rcnName] = round((row[2]*900.0)/4046.86,2)

#iterate through rcnResults dictionary, calculating the % project areas in the RCN
for rcnProj in rcnResults:
    rcnResult = rcnResults[rcnProj]
    projAcres = round(projDict[rcnProj][4]*900/4046.86,2) #projDict = {projID: [projName, outRow, vectorhectares, rasterhectares, number cells]}

    rcnAcres = 0.0
    #iterate through classes in the rcnResults dictionary, adding the value to the running rcnCount
    for rcnClass in rcnResult:
        currAcre = rcnResult[rcnClass]
        rcnAcres+=currAcre

    #calculate percent of project area in the RCN and add to the rcnResults dictionary
    rcnPct = int(round((rcnAcres/projAcres)*100.0,0))
    rcnResults[rcnProj]["% Project area in RCN"] = rcnPct
    rcnResults[rcnProj]["Total area in RCN"] = rcnAcres
...
#add new worksheet for writing rcn results and write template cells
rcnsheet = workbook.add_worksheet("RCNStatistics")
rcnsheet.set_column(0,2,11.0)
rcnsheet.set_column(3,15,20.0)

rcnsheetList = [[0,0,'Project Name',bordForm],
[0,1,'Project ID',bordForm],
[0,2,'Project area (vector acres) *GIS calc.',bordForm],
[0,3,"% Project area in RCN",colForm],
[0,4,"Total area in RCN (raster acres)",colForm],
[0,5,'Area in Resilient Diffuse Flow High class (raster acres)',colForm],
[0,6,'Area in Resilient Diffuse Flow High with Recognized Biodiversity class (raster acres)',colForm],
[0,7,'Area in Diffuse Flow (Climate Informed) class (raster acres)',colForm],
[0,8,'Area in Diffuse Flow (Climate Informed) with Recognized Biodiversity class (raster acres)',colForm],
[0,9,'Area in Concentrated Flow class (raster acres)',colForm],
[0,10,'Area in Concentrated Flow (Climate Informed) class (raster acres)',colForm],
[0,11,'Area in Resilient Land with Recognized Biodiversity Value class (raster acres)',colForm],
[0,12,'Area in Resilient Land (Secured) class (raster acres)',colForm],
[0,13,'Area in Coastal Marsh Migration Space class (raster acres)', colForm],
[0,14,'Area in NY Portfolio and Restoration Communities (Avg Resilience) class (raster acres)',colForm],
[0,15,'Area in NY Continental Connectors class (raster acres)',colForm]]

for rcnItem in rcnsheetList:
    rcnsheet.write(rcnItem[0], rcnItem[1], rcnItem[2], rcnItem[3])

#write rcn results to rcn sheet rcnResults = {projID: {rcnclass: hectares, rcnclass: hectares ...} ...}
for rcnResult in rcnResults:
    currRow = projDict[rcnResult][1]-2 #projDict = {projID: [projName, outRow, vectorhectares, rasterhectares, number cells]}
    currName = projDict[rcnResult][0]
    rcnsheet.write(currRow,0,currName,regForm) #projName
    rcnsheet.write(currRow,1,rcnResult,regForm) #projID
    currVecAc = round(projDict[rcnResult][2]*2.47105,2) #vector hectares*2.47105 acres/1ha
    rcnsheet.write(currRow,2,currVecAc,regForm)
    rcnList = rcnResults[rcnResult]

    for rcn in rcnDictionary:
        rcnCol = rcnDictionary[rcn]
        currrcnAc = rcnList[rcn]
        rcnsheet.write(currRow,rcnCol,currrcnAc,regForm)
...
#add new worksheet for writing ExE scores adnd write template cells
exesheet = workbook.add_worksheet("ExEScores")

exesheet.set_column(0,2,11.0)
exesheet.set_column(3,37,11.71)
exesheetList = [[0,2,'Target System>',italralForm],[1,2,'Attribute Group>',italralForm],[0,4,'Freshwater',bordForm],[0,5,'Freshwater',bordForm],[0,6,'Freshwater',bordForm],[0,7,'Freshwater',bordForm],[0,8,'Freshwater',bordForm],[0,9,'Freshwater',bordForm],[0,10,'Freshwater',bordForm],[0,11,'Freshwater',bordForm],[0,12,'Freshwater',bordForm],[0,13,'Freshwater',bordForm],[0,14,'Terrestrial',bordForm],[0,15,'Terrestrial',bordForm],[0,16,'Terrestrial',bordForm],[0,17,'Terrestrial',bordForm],[0,18,'Terrestrial',bordForm],[0,19,'Terrestrial',bordForm],[0,20,'Terrestrial',bordForm],[0,21,'Terrestrial',bordForm],[0,22,'Terrestrial',bordForm],[0,23,'Marine',bordForm],[0,24,'Marine',bordForm],[0,25,'Marine',bordForm],[0,26,'Marine',bordForm],[0,27,'Marine',bordForm],[0,28,'People',bordForm],[0,29,'People',bordForm],[0,30,'People',bordForm],[0,31,'People',bordForm],[0,32,'People',bordForm],[0,33,'People',bordForm],[0,34,'People',bordForm],[0,35,'People',bordForm],[0,36,'People',bordForm],[0,37,'People',bordForm],[1,3,'Threat',bordForm],[1,4,'Condition',bordForm],[1,5,'Condition',bordForm],[1,6,'Condition',bordForm],[1,7,'Condition',bordForm],[1,8,'Condition',bordForm],[1,9,'Diversity',bordForm],[1,10,'Diversity',bordForm],[1,11,'Habitat',bordForm],[1,12,'Habitat',bordForm],[1,13,'Resilience',bordForm],[1,14,'Climate mitigation',bordForm],[1,15,'Climate mitigation',bordForm],[1,16,'Condition',bordForm],[1,17,'Condition',bordForm],[1,18,'Condition',bordForm],[1,19,'Diversity',bordForm],[1,20,'Diversity',bordForm],[1,21,'Diversity',bordForm],[1,22,'Reslience',bordForm],[1,23,'Condition',bordForm],[1,24,'Condition',bordForm],[1,25,'Condition',bordForm],[1,26,'Habitat',bordForm],[1,27,'Habitat',bordForm],[1,28,'Flooding',bordForm],[1,29,'Flooding',bordForm],[1,30,'Flooding',bordForm],[1,31,'Flooding',bordForm],[1,32,'Recreation',bordForm],[1,33,'Recreation',bordForm],[1,34,'Recreation',bordForm],[1,35,'Temperature regulation',bordForm],[1,36,'Water supply',bordForm],[1,37,'Water supply',bordForm],[2,0,'Project Name',bordForm],[2,1,'Project ID',bordForm],[2,2,'Project area (Ha) *GIS calc.',bordForm],[2,3,'Land use intensification',colForm],[2,4,'Floodplain function',colForm],[2,5,'Freshwater flows',colForm],[2,6,'Freshwater NPS mitigation',colForm],[2,7,'Freshwater NPS prevention',colForm],[2,8,'Riparian function',colForm],[2,9,'Aquatic diversity',colForm],[2,10,'Stream physical variety',colForm],[2,11,'Floodplain habitat',colForm],[2,12,'Wetland habitat',colForm],[2,13,'Stream resilience',colForm],[2,14,'Carbon sequestration',colForm],[2,15,'Carbon storage',colForm],[2,16,'Terrestrial climate flow',colForm],[2,17,'Terrestrial connectivity',colForm],[2,18,'Terrestrial habitat quality',colForm],[2,19,'Terrestrial diversity',colForm],[2,20,'Terrestrial habitat variety',colForm],[2,21,'Terrestrial physical variety',colForm],[2,22,'Terrestrial resilience',colForm],[2,23,'Marine N prevention',colForm],[2,24,'Marine NPS reduction',colForm],[2,25,'Shoreline dynamics',colForm],[2,26,'Future tidal wetlands',colForm],[2,27,'Present tidal wetlands',colForm],[2,28,'Flood damage prevention',colForm],[2,29,'Marine storm surge mitigation',colForm],[2,30,'Riverine flood mitigation',colForm],[2,31,'Riverine flood reduction',colForm],[2,32,'Freshwater aquatic recreation',colForm],[2,33,'Marine aquatic recreation',colForm],[2,34,'Terrestrial recreation',colForm],[2,35,'Heat mitigation',colForm],[2,36,'Ground water supply',colForm],[2,37,'Surface water supply',colForm]
]

for exeItem in exesheetList:
    exesheet.write(exeItem[0],exeItem[1],exeItem[2],exeItem[3])
...
for projResult in projResults: #projResults = {projID: {attribute: [mean sens, efficiency score, effectiveness score, ExE score] ...} ...}
    ...
    exesheet.write(currRow,0,currName,regForm)
    exesheet.write(currRow,1,projResult,regForm)
    ...
    exesheet.write(currRow,2,currVecHa,regForm)
    ...
    for att in projAttList:
        ...
        if att[-2:] in ['fn','bp','bv']:
            ...
            #if current att is not one of the people components, proceed with writing mean, efficiency, effectivness, ExE
            meanCol = meanColDictionary[att]
            currMean = projAttList[att][0]
            meansheet.write(currRow,meanCol,currMean,regForm)
            ...
            currExe = projAttList[att][3]
            exesheet.write(currRow,attCol,currExe,regForm)
...
if report == "true":
    ...
    with xlsxwriter.Workbook(outReport) as resultbook:
        ...
        resultsheet.set_margins(top=0.25,bottom=0.25,left=0.25,right=0.25)
        ...
        for proj in projDict: #projDict = {projID: [projName, outRow, vectorhectares, rasterhectares, number cells]}
            ...
            tallRows = [(p*84) + 0, (p*84) + 5, (p*84) + 8, (p*84) + 37, (p*84) + 80]
            ...
            shortRows = [(p*84) + 1, (p*84) + 2, (p*84) + 3, (p*84) + 4, (p*84) + 6, (p*84) + 7, (p*84) + 33, (p*84) + 34, (p*84) + 35, (p*84) + 36, (p*84) + 78, (p*84) + 79, (p*84) + 82, (p*84) + 83]
            ...
            #retrieve name of current project
            if len(projDict[proj][0])>44:
                currProjName = projDict[proj][0][0:31] + '...'
            else:
                currProjName = projDict[proj][0]
            ...
            data = [[(p*84)+1,1,queName,regForm],[(p*84)+2,1,user,regForm],[(p*84)+3,1,fooTime,regForm],[(p*84)+4,1,projIDField,regForm],[(p*84)+1,4,str(proj),lalForm],[(p*84)+2,4,currProjName,regForm],[(p*84)+3,4,str(currVecHa) + " Ha (" + str(currVecAc) + " acres)",regForm],[(p*84)+35,0,"Query Name: " + str(queName),regForm],[(p*84)+35,5,"Project Shape ID: " + str(proj),ralForm]]

            dataMerge = [[(p*84)+5,1,(p*84)+5,5,projects,wrapForm],[(p*84)+34,0,(p*84)+34,5,"page " + str(pg),centForm],[(p*84)+83,0,(p*84)+83,5,"page " + str(pg+1),centForm]]
            ...
            #retrieve rcn results for current project and write to report
            currRcnResults = rcnResults[proj]
            currRcnAcres = currRcnResults["Total area in RCN"]
            currRcnPct = currRcnResults["% Project area in RCN"]
            resultsheet.write((p*84)+4,4,str(currRcnPct) + "% of project area (" +str(currRcnAcres) + " acres)",regForm)
...
if spatial == 'true':
    ...
    #add fields to the outspatial dataset for writing RCN statistics
    arcpy.AddField_management(outSpatial, "rcn_acres", "DOUBLE")
    arcpy.AddField_management(outSpatial, "rcn_pct", "DOUBLE")
    rcnUpdate = [projIDField, "rcn_acres", "rcn_pct"]

    #update rcn fields in outSpatial dataset
    with arcpy.da.UpdateCursor(outSpatial,rcnUpdate) as cursor:
        for row in cursor:
            currId = row[0]
            idResults = rcnResults[currId]
            row[1] = idResults["Total area in RCN"]
            row[2] = idResults["% Project area in RCN"]
            cursor.updateRow(row)
